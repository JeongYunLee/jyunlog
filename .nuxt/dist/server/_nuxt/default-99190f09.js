import { a as Html, B as Body } from "./components-6ce1bb61.js";
import { _ as __nuxt_component_0$3 } from "./SectionContainer-a4c68ffb.js";
import { _ as __nuxt_component_0$1 } from "./nuxt-link-5d0b373b.js";
import { defineComponent, ref, createElementBlock, withCtx, createVNode, useSSRContext, mergeProps, unref, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, renderSlot } from "vue";
...
import { _ as __nuxt_component_0$2 } from "./SocialIcon-c2d691da.js";
import "hookable";
import "destr";
import "devalue";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SocialIcon = __nuxt_component_0$2;
      const _component_NuxtLink = __nuxt_component_0$1;
      ...
      _push(`</div><div class="mb-2 flex space-x-2 text-sm text-gray-500 dark:text-gray-400"><div>${ssrInterpolate(unref(siteMetadata).author)}</div><div>${ssrInterpolate(` • `)}</div><div>${ssrInterpolate(`© ${(/* @__PURE__ */ new Date()).getFullYear()}`)}</div><div>${ssrInterpolate(` • `)}</div>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SectionContainer = __nuxt_component_0$3;
      const _component_NuxtLink = __nuxt_component_0$1;
...
//# sourceMappingURL=default-99190f09.js.map
