function useConstants() {
  ...
  const projects = [
    {
      ...
      description: "A personal blog using NextJS and Notion API. It has code syntax highlight and image viewer.",
      techStack: [
        "NextJS",
        "TS",
        "TailwindCSS",
    ...
    },
    {
      ...
      description: "An order creation and management web app. It can be use to manage orders and prodcuts.",
      techStack: [
        "NextJS",
        "TS",
        "TailwindCSS",
    ...
    },
    {
      ...
      description: "A Spotify clone web app. Built to view your saved and created playlist. It also can control your Spotify app playback state.",
      techStack: [
        "Vue",
        "Vite",
        "TailwindCSS",
    ...
    },
    {
      ...
      description: "A static E-Commerce website to demonstrate the flow of a user purchase",
    ...
    },
    {
      ...
      description: "A door-to-door saloon appointment booking website allows users to book their appointment at any time.",
      techStack: [
        "Vue",
        "TS",
        "Vite",
  ...
  const workingProjects = [
    ...
    },
    {
      ...
      highlights: "Render selectable dates based on postcode input, website maintenance",
      urls: [
        {
          name: "Bloomeroo",
  ...
  const timeline = [
    ...
    // },
    {
      ...
      description: "COSADAMA(2020-01-13 ~) is the programming community especially for non-majors by students of Chung-Ang university, Seoul, Korea. As a member and a staff of COSADAMA, I was in charge of managing the team and develoing the curriculum website.",
      // icon: "",
      link: {
        text: "Visit COSADAMA",
    ...
    },
    {
      ...
      description: " Team.Cayley is made up of students from Chung-Ang University, majoring in Library and Information Science and COSADAMA. You can see our performance at the following links and GitHub.                     1. 'COVID-19: Our Memory' project: We archieve our society's changes due to the COVID-19 pandemic as data, and preserve the data for future reference. We donated our digital archieve to the National Library of Korea. (2022.02)                     2. 'Cultural Heritage Synapse: Linking National treasure data' project: We gathered scattered information in about 65 sources of online and offline to create one high-quality data and proposed a standard for national treasure data. Using the data we made some text analysis, a knowledge graph of the cultural heritage data of the National Treasure.",
      // icon: "",
      link: {
    ...
    },
    {
      ...
      description: "Chung-Ang University, Seoul, South Korea",
      // icon: "",
      link: {
        text: "Visit CAU",
...
//# sourceMappingURL=const-369fb235.js.map
