...
import "klona";
import { q as queryContent, e as encodeQueryParams, j as jsonStringify } from "./query-6b46fb82.js";
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./client-db-1189c4af.js").then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-d8b0958c.js.map
