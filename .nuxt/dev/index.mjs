globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/defu/dist/defu.mjs';
import { hash as hash$1 } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unified/index.js';
import { toString } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/remark-rehype/index.js';
import { all } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/detab/index.js';
import { u } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unist-builder/index.js';
import { encode } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/mdurl/index.js';
import slugify from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/slugify/slugify.js';
import { position } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unist-util-position/index.js';
import { visit } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unist-util-visit/index.js';
import { FontStyle, BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/shiki-es/dist/shiki.node.mjs';
import { consola } from 'file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/unenv/runtime/npm/consola.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/jeongyunl/Documents/GitHub/jyunlog/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/jeongyunl/Documents/GitHub/jyunlog/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jeongyunl/Documents/GitHub/jyunlog/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jeongyunl/Documents/GitHub/jyunlog","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jeongyunl/Documents/GitHub/jyunlog/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jeongyunl/Documents/GitHub/jyunlog/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jeongyunl/Documents/GitHub/jyunlog/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Tzhy3zLBgm = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/jeongyunl/Documents/GitHub/jyunlog/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _lazy_g87oOU = () => Promise.resolve().then(function () { return buttondown_post$1; });
const _lazy_VNAuqC = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _xTWRcc, lazy: false, middleware: false, method: "get" },
...
const buttondown_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: buttondown_post
});
...
const getClientManifest = () => import('/Users/jeongyunl/Documents/GitHub/jyunlog/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/jeongyunl/Documents/GitHub/jyunlog/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
