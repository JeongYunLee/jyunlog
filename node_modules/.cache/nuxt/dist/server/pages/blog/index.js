...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/index.vue?vue&type=template&id=486950da&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<header class=\"pt-16 pb-9 sm:pb-16 sm:text-center\"><h1 class=\"mb-4 text-8xl sm:text-4xl tracking-tight text-slate-800 font-extrabold dark:text-slate-200\">\n      Blog\n    </h1> <p class=\"text-lg text-slate-700 dark:text-slate-400\">\n      I write about web development, tech, and other things.\n    </p></header> "),_vm._ssrNode("<div class=\"space-y-16 mx-auto max-w-6xl\">","</div>",_vm._l((_vm.articles),function(article){return _c('blog-item',{key:article.title,attrs:{"title":article.title,"description":article.description,"date":article.date,"slug":article.slug}})}),1)],2)}
var staticRenderFns = []
...
installComponents(component, {BlogItem: __webpack_require__(77).default})
